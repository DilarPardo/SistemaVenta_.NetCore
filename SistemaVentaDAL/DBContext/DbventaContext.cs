...
namespace SistemaVentaDAL.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CCB5CF029");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F4B03D09F");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483BE953E9D");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107F8D200AC");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E8806A0BF");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132DC56A32A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76969E1020");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D81416EDD0");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEB40E2E72");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BF196A02");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56141C2B663E");
